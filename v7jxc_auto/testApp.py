...
get_by_local.get_element('add',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('coustmer_botton',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('search_coustmer_box',meg="saleOrder_element").send_keys(u"华为")
time.sleep(3)
get_by_local.get_element('select_coustmer',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('salesman_button',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('select_salesman_baili',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('add_goods',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('goods_group_lingshi',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('jia',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('goods_showmore',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('select_stock',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('select_stock_baihuo',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('good_quantity',meg="saleOrder_element").clear().send_keys(5)
get_by_local.get_element('discont2',meg="saleOrder_element").click()
get_by_local.get_element('discont2_money',meg="saleOrder_element").send_keys(3)
get_by_local.get_element('confirm',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('confirm_select',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('Settlement',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('deposit_button',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('account',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('select_account',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('deposit_pay',meg="saleOrder_element").send_keys(47)
get_by_local.get_element('pay_showmore',meg="saleOrder_element").click()
get_by_local.get_element('place_saleorder',meg="saleOrder_element").click()

#下推

switch_to_context()
get_by_local.get_element('saleOrder_list',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('select_date',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('date_today',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('purinbound_staus',meg="saleOrder_element").click()
switch_to_context()
T=get_by_local.get_element('unaudited',meg="saleOrder_element")
print(T.text)
T.click()
# get_by_local.get_element('unaudited',meg="saleOrder_element").click()
switch_to_context()
get_by_local.get_element('saleorder_billno',meg="saleOrder_element").click()

switch_to_context()
get_by_local.get_element('saleorder_audit_button',meg="saleOrder_element").click()
time.sleep(5)
get_by_local.get_element('out_warehousr',meg="saleOrder_element").click()
#出库
switch_to_context()
get_by_local.get_element('Settlement',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('collection_button',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('account',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('select_account',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('collection',meg="salOutbound_element").send_keys(47)
switch_to_context()
get_by_local.get_element('place_saleorder',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('saleOrder_list',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('select_date',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('date_today',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('purinbound_staus',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('unaudited',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('saleorder_billno',meg="salOutbound_element").click()
switch_to_context()
get_by_local.get_element('saleorder_audit_button',meg="salOutbound_element").click()
